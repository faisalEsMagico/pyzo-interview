...
const ShortListingCriteriaTable = ({ skillevaluations, criteriaDecisions, HeaderBg = '#0D111B', bodyBg = '#FFFFFF', color = '#333333', borderColor = '#E0E2E7' }: any) => {
    const headerStyle = {
    ...
    return (
        <>
            ...
            {skillevaluations && skillevaluations.length > 0 && (
                <Box
                    overflow={'auto'}
                    marginBottom={'16px'}
                    borderRadius="12px"
                ...
                >
                    ...
                    >
                        {/* Skill Evaluation Section Header */}
                        <thead
                            style={{
                        ...
                        >
                            ...
                            <tr style={{ borderBottom: `2px solid ${borderColor}` }}>
                                ...
                                <th style={{ ...headerStyle, width: '20%' }}>Skill Tested</th>
                        ...
                        <tbody style={{ backgroundColor: bodyBg }}>
                            {skillevaluations?.map((item: any, i: number) => (
                                <tr key={i} style={{ borderBottom: `1px solid ${borderColor}` }}>
                                    <td style={{ ...textStyle }}>{i + 1}</td>
                                    <td style={{ ...textStyle }}>{item.skill}</td>
                                    <td style={{ ...textStyle, textAlign: 'center' }}>{item.score !== null ? item.score : '--'}</td>
...
export default ShortListingCriteriaTable;
